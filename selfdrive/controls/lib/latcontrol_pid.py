...
MODEL_MIN_SPEED = 12 # minimum speed to use model
...
try:
  wb = np.load('/data/openpilot/model_sshane_weights.npz', allow_pickle=True)
except:
  wb = np.load('/home/gregor/openpilot/model_sshane_weights.npz', allow_pickle=True)
w, b = wb['wb']
